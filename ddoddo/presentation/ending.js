...
export function showCreditsScreen() {
    ...
    const content = `
        ...
        <div style="font-size: clamp(10px, 2vw, 16px); line-height: 2.2; margin-bottom: clamp(15px, 4vh, 40px);">
            ...
            <div style="margin-bottom: clamp(16px, 4vh, 40px); border: 2px solid #ffd700; padding: clamp(8px, 2vh, 20px) clamp(16px, 3vw, 32px); border-radius: 8px; background: rgba(255,215,0,0.08);">
                <p style="color: #fff; font-weight: bold;">[ Creative Director ]</p>
                <p style="color: #ffd700; font-size: clamp(14px, 3vw, 24px); text-shadow: 0 0 12px rgba(255,215,0,0.7); margin-top: 6px;">JACKSON KIM</p>
            </div>
